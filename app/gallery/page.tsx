...
export const metadata: Metadata = {
  title: 'Eaze Tours Gallery: Explore Our Memorable Journeys',
  description: 'Explore stunning moments from our tours, showcasing beautiful destinations, unforgettable experiences, and happy travelers with Eaze Tours.',
};
